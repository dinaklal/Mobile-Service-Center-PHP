      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="background-image:url('images/1.jpg') ;background-repeat: no-repeat; background-position: center;background-size: cover;">
          ...
          <div class="row placeholders">
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
                <a href="add_shop.php"> <button type="button" class="btn btn-lg btn-success">&nbsp;&nbsp;&nbsp;SEARCH&nbsp;&nbsp;&nbsp;</button></a>
              
              
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
                <a href="add_shop.php"> <button type="button" class="btn btn-lg btn-success">&nbsp;&nbsp;&nbsp;WORKS&nbsp;&nbsp;&nbsp;</button></a>
              
              
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
                <a href="add_shop.php"> <button type="button" class="btn btn-lg btn-success">SUMMARY&nbsp;&nbsp;</button></a>
