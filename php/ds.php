...
<div class="row">
           <div class="col-sm-5 col-sm-offset-1 col-md-2 col-md-offset-1 main"> <?php
					include 'db_connect.php';
	$f=$_POST['from'];
	$t=$_POST['to'];
	$q="SELECT * From `customer` WHERE date between '$f' and '$t'";
	...
	echo " <b><form class='form-signin' role='form' action='work_submit_d.php' method='post'><div class='table-responsive'>
			...
			<thead><tr><th>CUSTOMER&nbspNAME</th><th>CONTACT</th><th>PLACE</th><th>TYPE</th><th>MODEL</th><th>PROBLEM&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th><th>DESCRIPTION&nbsp&nbsp&nbsp</th><th>AMOUNT&nbsp&nbsp&nbsp&nbsp</th><th>STATUS&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th><th></th></tr></thead>";
...
<div class="row">
	...
	$f=$_POST['from'];
	$t=$_POST['to'];
	$q="SELECT * From `shops` join `works` on `shops`.id=`works`.shop_id WHERE 	`works`.date between '$f' and '$t'";
	$res=mysqli_query($con,$q);
	echo " <b><form class='form-signin' role='form' action='work_submit_d.php' method='post'><div class='table-responsive'>
            <table class='table table-bordered' style='margin-left:-10%;'>
